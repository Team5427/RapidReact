...
public class RobotContainer {
  ...
  private static MotorController left1;
  private static MotorController left2;
  private static MotorController right1;
  private static MotorController right2;
  ...
  left1 = new WPI_VictorSPX(Constants.LEFT_MOTOR1);
  left2 = new WPI_VictorSPX(Constants.LEFT_MOTOR2);
  right1 = new WPI_VictorSPX(Constants.RIGHT_MOTOR1);
  right2 = new WPI_VictorSPX(Constants.RIGHT_MOTOR2);
  left = new MotorControllerGroup(left1, left2);
  right = new MotorControllerGroup(right1, left2);
