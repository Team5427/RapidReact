...
public final class Constants {
    ...
    public static final double ksVolts = 0.21003; //FIXME
    public static final double kvVoltSecondsPerMeter = 0.060019; //FIXME
    public static final double kaVoltSecondsSquaredPerMeter = 0.016781; //FIXME

    // Example value only - as above, this must be tuned for your drive!
    public static final double kPDriveVel = 8.5; //FIXME still have to tune
